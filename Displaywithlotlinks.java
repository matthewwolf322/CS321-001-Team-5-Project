...
public class Display extends JFrame{
  ...
  public void createMainFrame() throws IOException{
    ...
    mapPanel = new JPanel();
    BufferedImage image = ImageIO.read(new File("C:/Users/asput/Desktop/CS 321 - Software Engineering/CS321-001-Team-5-Project-master/CS321-001-Team-5-Project-master/assets/mapOfFairfaxCampus.png"));
  ...
  public void createfirstFrame(LotDistance [] ld) throws IOException{
    ...
    String 1st_lot_name = ld[0].getName();
    
    first_map_Panel = new JPanel();
    BufferedImage image2 = ImageIO.read(new File(getImage(1st_lot_name));
  ...
  public void createsecondFrame(LotDistance [] ld) throws IOException{
    ...
    // will all permit types have at least 3 associated lots?
    String 2nd_lot_name = ld[1].getName();
    
    second_map_Panel = new JPanel();
    BufferedImage image3 = ImageIO.read(new File(getImage(2nd_lot_name));
  ...
  public void createfirstFrame(LotDistance [] ld) throws IOException{
    ...
    // will all permit types have at least 3 associated lots?
    String 3rd_lot_name = ld[2].getName();
    
    third_map_Panel = new JPanel();
    BufferedImage image4 = ImageIO.read(new File(getImage(3rd_lot_name));
  ...
  public String getPermitImage(String permit_name) {
